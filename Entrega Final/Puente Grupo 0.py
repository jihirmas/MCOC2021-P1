...
seccion_grande = SeccionICHA("[]100×100×14.2", color="#3A8431")#, debug=True)
for i in range(20):
...
seccion_grande = SeccionICHA("[]100×100×14.2", color="#3A8431")#, debug=True)
ret.agregar_barra(Barra(67,69, SeccionICHA("[]12×12×0.3", color="#3A8431")))
ret.agregar_barra(Barra(69,68, SeccionICHA("[]12×12×0.3", color="#3A8431")))
ret.agregar_barra(Barra(68,66, SeccionICHA("[]12×12×0.3", color="#3A8431")))
ret.agregar_barra(Barra(66,67, SeccionICHA("[]12×12×0.3", color="#3A8431")))
...
for i in range(0,len(factores_de_utilizacion)):
    if i < 175:
        k = seccc.index(barras_a_cambiar[i].seccion.denominacion)
    else: 
        seccion_grande = SeccionICHA("[]100×100×16.7", color="#3A8431")#, debug=True)
    ret.resolver_sistema()
    factores_de_utilizacion = ret.obtener_factores_de_utilizacion(fu, ϕ=0.9)
    for j in range(k,len(seccc)):
        # cont+=1
        ...
        if cont > 50:
            break
        if factores_de_utilizacion[i]>1:#0.001:
            # print("entre")
...
barras_a_cambiar[8].seccion = SeccionICHA("[]300×150×27.3", color="#3A8431")
barras_a_cambiar[9].seccion = SeccionICHA("[]300×150×27.3", color="#3A8431")
for i in range(21,38):
    barras_a_cambiar[i].seccion = SeccionICHA("[]300×150×27.3", color="#3A8431")
barras_a_cambiar[33].seccion = SeccionICHA("[]300×150×33.9", color="#3A8431")
barras_a_cambiar[34].seccion = SeccionICHA("[]300×150×33.9", color="#3A8431")
barras_a_cambiar[35].seccion = SeccionICHA("[]300×150×33.9", color="#3A8431")
barras_a_cambiar[36].seccion = SeccionICHA("[]300×150×33.9", color="#3A8431")
barras_a_cambiar[47].seccion = SeccionICHA("[]300×150×27.3", color="#3A8431")
barras_a_cambiar[48].seccion = SeccionICHA("[]300×150×27.3", color="#3A8431")
for i in range(139,139+40):
    barras_a_cambiar[i].seccion = SeccionICHA("[]20×20×1.0", color="#3A8431")
barras_a_cambiar[179].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
# barras_a_cambiar[178].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
barras_a_cambiar[180].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
barras_a_cambiar[181].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
barras_a_cambiar[182].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
barras_a_cambiar[183].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
# barras_a_cambiar[184].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
barras_a_cambiar[185].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
barras_a_cambiar[30].seccion = SeccionICHA("[]40×40×4.8", color="#3A8431")
barras_a_cambiar[26].seccion = SeccionICHA("[]40×40×3.2", color="#3A8431")
# barras_a_cambiar[186].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
# barras_a_cambiar[195].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
# barras_a_cambiar[196].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
# barras_a_cambiar[197].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
# barras_a_cambiar[198].seccion = SeccionICHA("[]12×12×0.3", color="#3A8431")
ret.resolver_sistema()
...
# for i in barras_a_cambiar:
#     print(i.seccion.denominacion)
ret.guardar("Puente Grupo 0 final.h5")